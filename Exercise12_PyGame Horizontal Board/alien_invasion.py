...
class AlienInvasion:
    ...
    def _update_aliens(self):
        ...
        # Look for aliens hitting the leftmost screen.
        self._check_aliens_leftmost()

    def _check_aliens_leftmost(self):
        """Check if any aliens have reached the leftmost screen."""
    ...
    def _create_alien(self, alien_number, column_number):
        ...
        alien.rect.x = self.settings.screen_width - (alien.rect.width + 2
                                                     * alien.rect.width
                                                     * column_number)
